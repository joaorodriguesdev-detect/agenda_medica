...
// Ícones minimalistas para a Sidebar
const Icons = {
...
export default function Home() {
  ...
  const [visao, setVisao] = useState("calendario"); // 'calendario' ou 'tabela'
  const tableRef = useRef<any>(null);
  const router = useRouter();

  // Mantemos o consumo da API real para preencher o Tabulator exigido no teste[cite: 2]
  useEffect(() => {
    ...
    <div className={`${display.variable} ${body.variable} ${mono.variable} flex h-screen bg-[#F6F7F9] font-body text-black`}>
        ...
        <div className="w-[260px] bg-white border-r border-[#E7E9EC] flex flex-col">
          ...
          <div className="p-5 border-b border-[#F1F2F4]">
            ...
            <div className="grid grid-cols-7 gap-1 text-center text-xs text-[#5B6472]">
              {/* Linhas simuladas do calendário */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <main className="flex-1 overflow-auto bg-[#F6F7F9]">
          ...
          {visao === 'calendario' ? (
            // VISUALIZAÇÃO DE CALENDÁRIO (Mockada baseada na imagem)
            <div className="h-full flex flex-col min-w-[800px]">
              ...
              <div className="grid grid-cols-4 flex-1">
                ...
                <div className="relative p-3">
                  {/* Coluna vazia como na imagem */}
                </div>
              </div>
            </div>
          ) : (
            // VISUALIZAÇÃO TABULATOR (Código Oficial do Teste)
